        ...
        <div class="initiatives">
            <div class="row">
                <div class="col m8">
                    ...
                    <div class="row">
                        <div id="active-inits" class="col s12">
                            <div class="row">
                        ...
                        <div id="archive-inits" class="col s12">
                            @forelse($initiativesExpired as $initiative)
                            <div class="col s12 l6 xl4">
                                <div class="card">
                ...
                <iframe class="col m4 input-map" title="input a location" src="{{ env('AREAVIEWER_URL') }}?domain={{ config('app.url') }}&applications={{ env('OTM_APP_ID') }}&zoom=14&contrast=false&c={{ env('AREAVIEWER_CENTER') }}"></iframe>
            </div>
        </div>
    </div>
@endsection
